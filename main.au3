...
FileInstall("scenario\guest\BuyItems.sce", "scenario\BuyItems.sce", 1)
FileInstall("scenario\guest\CauPhuc.sce", "scenario\CauPhuc.sce", 1)
FileInstall("scenario\guest\LatThe.sce", "scenario\LatThe.sce", 1)
FileInstall("scenario\guest\NhanSoiNoi.sce", "scenario\NhanSoiNoi.sce", 1)
FileInstall("scenario\guest\ShowHide0.sce", "scenario\ShowHide0.sce", 1)
FileInstall("scenario\guest\ShowHide1.sce", "scenario\ShowHide1.sce", 1)
FileInstall("scenario\guest\ShowHide2.sce", "scenario\ShowHide2.sce", 1)
FileInstall("scenario\guest\ShowHide3.sce", "scenario\ShowHide3.sce", 1)
FileInstall("scenario\guest\ShowHide4.sce", "scenario\ShowHide4.sce", 1)
