...
Func BuildUI()
   ...
   Local $tvp1 = GUICtrlCreateCheckbox (_DateDayOfWeek (1), 30, 135, 90, $rowHeight)
   Local $tvp2 = GUICtrlCreateCheckbox (_DateDayOfWeek (2), 30, 155, 90, $rowHeight)
   Local $tvp3 = GUICtrlCreateCheckbox (_DateDayOfWeek (3), 30, 175, 90, $rowHeight)
   Local $tvp4 = GUICtrlCreateCheckbox (_DateDayOfWeek (4), 30, 195, 90, $rowHeight)
   Local $tvp5 = GUICtrlCreateCheckbox (_DateDayOfWeek (5), 30, 215, 90, $rowHeight)
   Local $tvp6 = GUICtrlCreateCheckbox (_DateDayOfWeek (6), 30, 235, 90, $rowHeight)
   Local $tvp7 = GUICtrlCreateCheckbox (_DateDayOfWeek (7), 30, 255, 90, $rowHeight)
   ...
   Local $bc1 = GUICtrlCreateCheckbox (_DateDayOfWeek (1), 30, 135, 90, $rowHeight)
   Local $bc2 = GUICtrlCreateCheckbox (_DateDayOfWeek (2), 30, 155, 90, $rowHeight)
   Local $bc3 = GUICtrlCreateCheckbox (_DateDayOfWeek (3), 30, 175, 90, $rowHeight)
   Local $bc4 = GUICtrlCreateCheckbox (_DateDayOfWeek (4), 30, 195, 90, $rowHeight)
   Local $bc5 = GUICtrlCreateCheckbox (_DateDayOfWeek (5), 30, 215, 90, $rowHeight)
   Local $bc6 = GUICtrlCreateCheckbox (_DateDayOfWeek (6), 30, 235, 90, $rowHeight)
   Local $bc7 = GUICtrlCreateCheckbox (_DateDayOfWeek (7), 30, 255, 90, $rowHeight)
   ...
   GUICtrlCreateLabel("No", 150, 138, 30, $rowHeight)
   Local $bcNo = GUICtrlCreateCombo("", 180, 135, 40, $rowHeight)
   GUICtrlSetData($bcNo, "1|2", "2")
   Local $receiveAward1 = GUICtrlCreateCheckbox("Receive Actitive Award", 240, 135, 150, $rowHeight)

   GUICtrlCreateTabItem("NguTrucDam")
   Local $ntd1 = GUICtrlCreateCheckbox (_DateDayOfWeek (1), 30, 135, 90, $rowHeight)
   Local $ntd2 = GUICtrlCreateCheckbox (_DateDayOfWeek (2), 30, 155, 90, $rowHeight)
   Local $ntd3 = GUICtrlCreateCheckbox (_DateDayOfWeek (3), 30, 175, 90, $rowHeight)
   Local $ntd4 = GUICtrlCreateCheckbox (_DateDayOfWeek (4), 30, 195, 90, $rowHeight)
   Local $ntd5 = GUICtrlCreateCheckbox (_DateDayOfWeek (5), 30, 215, 90, $rowHeight)
   Local $ntd6 = GUICtrlCreateCheckbox (_DateDayOfWeek (6), 30, 235, 90, $rowHeight)
   Local $ntd7 = GUICtrlCreateCheckbox (_DateDayOfWeek (7), 30, 255, 90, $rowHeight)
   ...
   GUICtrlCreateLabel("No", 150, 138, 30, $rowHeight)
   Local $ntdNo = GUICtrlCreateCombo("", 180, 135, 40, $rowHeight)
   GUICtrlSetData($ntdNo, "1|2|3|4|5|6|7|8|9", "2")
   Local $receiveAward2 = GUICtrlCreateCheckbox("Receive Actitive Award", 240, 135, 150, $rowHeight)
   ...
   While True
	  Switch GUIGetMsg()
		 ...
		 Case $buttonRun
			...
			$ntdFeature.Add("Scheduler", $tvpSchedule)
			If GUICtrlRead($receiveAward1) = $GUI_CHECKED Then
			   Local $ntdFuncs = ['AssignChallenge', 'GetActiveAeard']
			   $ntdFeature.Add("Functions", $tvpFuncs)
			Else
			   Local $ntdFuncs = ['AssignChallenge']
			   $ntdFeature.Add("Functions", $tvpFuncs)
			EndIf
			For $j = 0 To GUICtrlRead($ntdNo)
